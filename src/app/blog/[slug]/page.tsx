...
const posts = [
  {
    ...
    content: `Virgin Oil D6 is also known as Residual Fuel Oil and is of high viscosity. This particular fuel oil requires preheating to 220 – 260 Degrees Fahrenheit. D6 is mostly used for generators. D6 is a type of residual fuel, mainly used in power plants and larger ships.
...
Contact us today to discuss your D6 requirements and get a competitive quote from our experienced team.`,
  },
  {
    ...
    content: `When you think of buying Liquefied Petroleum Gas (LPG) from credible sources, contact Barry Lantern Oil & Gas Limited. Our vast years of experience in the industry and track record with numerous clients have earned us a respectable place in the oil and gas supply industry.
...
Reach out to us today to place your LPG order or discuss bulk supply arrangements.`,
  },
  {
    ...
    content: `Bonny Light Crude oil is a high-grade Nigerian Crude Oil with high API Gravity and very low sulfur content. It is produced in the Niger Delta Basin and is named after a prolific region around the city of Bonny. It is a highly desired grade crude oil.
...
Contact our team today to discuss Bonny Light Crude Oil supply arrangements.`,
  },
  {
    ...
    image: "/blog4.jpg",
    title: "Jet Fuel A1",
    content: `We have suppliers of Jet Fuel (JP A1) and other grades. We help serious buyers secure genuine sellers of this product. Barry Lantern Oil & Gas Limited has a widespread network across Africa and the International Market Worldwide.
...
Contact us today if you are a serious buyer looking to procure Jet Fuel A1.`,
  },
  {
    ...
    content: `Petroleum coke, also known as petcoke, is a final carbon-rich solid material that derives from oil refining. Petcoke is derived from a final cracking process — a thermo-based chemical engineering process that splits long-chain hydrocarbons into shorter chains.
...
Contact our sales team today to discuss your petcoke requirements.`,
  },
  {
    ...
    content: `Automotive Gas Oil, or AGO, is the name given to fuel intended for use in road vehicles powered by diesel engines. AGO is used in Heavy-duty vehicles such as trucks and buses, and Light-duty vehicles such as vans and passenger cars.
...
Contact us today to discuss AGO supply for your business or personal needs.`,
  },
  {
    ...
    content: `Forcados Light Crude Oil is a high grade of Nigerian Crude Oil produced in the Niger Delta Basin. It is named after the prolific region around the Forcados. It is a highly desired grade crude oil for its uniqueness.
...
Barry Lantern Oil & Gas Limited facilitates Forcados Light Crude Oil transactions for verified buyers and sellers. Contact our team today to get started.`,
  },
  {
    ...
    content: `Liquefied Natural Gas (LNG) is natural gas predominantly methane, CH4, that has been cooled down to liquid form for ease and safety of non-pressurized storage or transport. It takes up about 1/600th the volume of the gas in the gaseous state at standard conditions.
...
Barry Lantern Oil & Gas Limited works with LNG suppliers and buyers to facilitate transactions across Nigeria and internationally. Contact us to discuss your LNG requirements.`,
  },
  {
    ...
    content: `We can supply Aviation Kerosene Colonial Grade JP54 and other grades to serious and capable buyers who can place the required instruments or who own their respective tank storage and can provide ATVs to our Partners, or provide a suitable Bank Instrument.
...
Barry Lantern Oil & Gas Limited has established networks to supply JP54 to serious buyers globally. Contact our team today to discuss your requirements and procurement process.`,
  },
  {
    ...
    content: `Mazut M 100 Fuel oil is supplied according to the Russian technical specification GOST 10585-99. This kind of oil is graded as heavy furnace oil. The product is produced from the remains of raw oil processing and is produced only from the low sulfur content crude oil.
...
Barry Lantern Oil & Gas Limited supplies Mazut M100 to industrial buyers and power plants. Contact our sales team to discuss your requirements.`,
  },
  {
    ...
    content: `Starting a business is the first step to owning a business, however having a successful business requires that you sustain and grow that business to ensure it remains alive and benefits your target audience for as long as possible.
      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center">
            ...
            <Link href="/" className="text-[#f0a500] font-bold hover:underline">
              ← Back to Home
            </Link>
          </div>
        </div>
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-[#001f3f] rounded-xl p-8 text-center">
            <h3 className="text-white font-bold text-xl mb-3">Interested in this product?</h3>
          ...
          <div className="mt-10 text-center">
            <Link href="/" className="inline-flex items-center gap-2 text-[#003366] font-bold hover:text-[#f0a500] transition-all text-sm">
              ← Back to Home
            </Link>
          </div>
